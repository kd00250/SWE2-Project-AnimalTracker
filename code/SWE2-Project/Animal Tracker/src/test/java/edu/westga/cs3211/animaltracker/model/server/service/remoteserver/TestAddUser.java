...
public class TestAddUser {
    ...
    void shouldReturnTrueWhenStatusIsSuccess() {
        ...
        AddUserRequest request = new AddUserRequest("alice", "pass123", Role.SCIENTIST);

        boolean result = server.addUser(request);
    ...
    @Test
    void shouldReturnTrueWhenStatusIsAnythingOtherThanError() {
        JSONObject response = new JSONObject();
